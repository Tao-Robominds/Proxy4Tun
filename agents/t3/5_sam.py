...
geometry_profile = config.get("geometry_profile", "t12")
mirror_k_geometry = bool(config.get("mirror_k_geometry", tunnel_id.split("-")[0] == "3"))
segment_loop_extra = int(config.get("segment_loop_extra", 0))
print(
    f"T3 SAM: geometry_profile={geometry_profile}, mirror_k={mirror_k_geometry}, "
