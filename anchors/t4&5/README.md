...
[`data/anchors/5-1/`](../../data/anchors/5-1/).

## Profiles

| Path | Role |
|---|---|
| `4-1/` | CLI default for `--profile t4&5`; anchor mIoU 0.741 |
| `5-1/` | Rings 110–119; recentre + detection tune; anchor mIoU 0.681 |
...
See [`reports/t45-4-1-swap-ab.md`](../../reports/t45-4-1-swap-ab.md) and
