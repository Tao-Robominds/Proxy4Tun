...
# boolean, and force theta handedness from that travel direction. Makes the
# unrolled frame independent of bounding-rect argmin tie-breaks and RANSAC
# noise, so segment_order becomes a fixed canonical constant.
