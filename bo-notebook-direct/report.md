...
Disabling canonical orientation does not always hurt: on a minority of
subsets the legacy handedness lands correctly by chance and notebook-mode
mIoU meets or exceeds the unified sibling-anchor (notable: `3-5` +0.274,
`4-4` +0.453, and several healthy continuous cases `3-6`/`3-7`/`3-10`).
The panel mean still drops by **0.265** because staggered and most complex
subsets collapse without the orientation / recentre adaptations
(worst: `1-2` −0.645, `5-4` −0.588, `5-2` −0.560).
