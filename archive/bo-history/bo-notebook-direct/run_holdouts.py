...
OUT_ROOT = REPO / "data" / "notebook-direct"
PARAMS_ROOT = REPO / "bo-notebook-direct" / "params"
...
def run_one(subset: str, force: bool = False) -> dict:
    ...
    input_txt = REPO / "data" / "subsets" / f"{subset}.txt"
    ...
    if out_dir.exists() and any(out_dir.iterdir()) and not force:
        ...
        rec = {
            ...
            "miou": miou,
            "profile": profile,
            "params_dir": str(params_dir.relative_to(REPO)),
