...
- **output:** `data/bo-full-stage/3-1-trials/runs/3-1-gate-seed1`

## Command

```bash
./venv/bin/python bo-full-stage/run_trials_full.py --case 3-1 --gate --force
```
...
From `data/reflect/campaign_cursor2.md` (stages 1–6 unlocked on 4-3):
