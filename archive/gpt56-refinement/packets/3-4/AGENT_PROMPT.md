# GPT-5.6 Sol reflection — subset 3-4 (round proposal)
...
- subset: `3-4`
- family: `t3`
- stage1_unlocked: `True` (residual=20.8 cm)
- anchor_proxy_scaled: `0.5737` (band=refine)

### GT-blind intrinsics
```json
{
  "orient_h_ring_corr": -0.9945070385871868,
...
```json
{
  "depth_nan_ratio": 0.19497856422227988,
  "denoise_retained_ratio": 0.6936518019734892,
  "unfold_residual": 3.0819099697950434,
  "orient_agreement": 0.9984156385609421,
  "sam_fill_rate": 0.5707661034176089,
  "sam_ontology_divergence": 0.1918493785939529,
  "det_row_residual_px": 3.5769805940726473,
  "det_row_gated": 1.0,
  "det_row_y_std": 22.90939289034417,
  "phase_incoherence_deg": 2.5
}
```
