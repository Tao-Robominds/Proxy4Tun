...
from bo.paths import REPO_ROOT, ELEGANT_DATA, ELEGANT_PKG, UNIFIED_PKG
from bo.unified.intrinsics import extract_intrinsics, write_intrinsics
from bo.unified.param_io import load_anchor_params, load_family_params, materialize_run_params
from bo.unified.pipeline import parse_performance, run_stages
from bo.elegant.features import family_of_subset

DATA_ROOT = ELEGANT_DATA
BAD_CONFIGS_PATH = UNIFIED_PKG / "family" / "bad_configs.json"
REGISTRY_PATH = ELEGANT_PKG / "registry.json"
