...
from bo.paths import ARCHIVE_V0_PKG, REPO_ROOT  # noqa: E402

if str(ARCHIVE_V0_PKG) not in sys.path:
    sys.path.insert(0, str(ARCHIVE_V0_PKG))
...
FAMILY_DIR = Path(__file__).resolve().parent / "family"
