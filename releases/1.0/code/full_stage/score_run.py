...
from bo.paths import REPO_ROOT, ELEGANT_DATA, FULL_STAGE_PKG, UNIFIED_DATA
from bo.elegant.features import ANCHOR_PARAMS, CANDIDATE, extract_lean
...
def _anchor_run_dir(subset: str) -> Path:
    candidates = [
        ...
        ELEGANT_DATA / f"{subset}-holdout" / "runs" / f"{subset}-anchor",
