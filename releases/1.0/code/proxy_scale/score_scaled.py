...
Wraps the frozen pooled lean proxy (bo.full_stage.score_run) and clips the
...
Usage:
  ./venv/bin/python bo/proxy_scale/score_scaled.py data/bo/reflect/3-4/cursor3/round1 --subset 3-4
  ./venv/bin/python bo/proxy_scale/score_scaled.py --subset 3-4 --anchor
"""
...
from bo.full_stage.score_run import _anchor_run_dir, score_run  # noqa: E402
