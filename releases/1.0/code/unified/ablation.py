...
from bo.unified.blocks import FEATURE_SETS, features_for  # noqa: E402
from bo.unified.family_proxy import (  # noqa: E402
    FAMILY_ONEHOT,
    FAM_TO_OH,
    TRAINING_CSV,
    _add_family_onehot,
...
from bo.unified.pipeline import DATA_ROOT  # noqa: E402
from bo.unified.spaces import FAMILY_HOLDOUT_SUBSETS  # noqa: E402

_PKG = Path(__file__).resolve().parent
FAMILY_DIR = _PKG / "family"

ABLATION_SETS = ("B1", "B2lean", "B2", "B1+B2lean", "B1+B2")
ABLATION_CSV = FAMILY_DIR / "ablation_scores.csv"
ABLATION_MD = _PKG / "ablation.md"
