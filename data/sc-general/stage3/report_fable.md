...
| mean selected proxy | 0.652 |
| mean anchor mIoU (offline) | 0.738 |
| mean selected mIoU (offline) | 0.768 |
| Δ mean mIoU | +0.030 |
| cases with mIoU↑ | 10 |
| cases with mIoU↓ | 5 |
...
- After refinement mean mIoU: **0.762** (paper reported 0.757)
...
- Overlap mean mIoU: 0.592 → 0.689

## Per-case table (panel)

| subset | family | anchor proxy | anchor mIoU | selected | sel proxy | sel mIoU | Δproxy | ΔmIoU |
|---|---|---:|---:|---|---:|---:|---:|---:|
| 4-3 | complex | 0.520 | 0.516 | round2 | 0.573 | 0.544 | +0.052 | +0.028 |
| 4-2 | complex | 0.543 | 0.734 | round2 | 0.685 | 0.773 | +0.141 | +0.039 |
| 4-1 | complex | 0.552 | 0.635 | round1 | 0.621 | 0.653 | +0.069 | +0.018 |
| 4-5 | complex | 0.609 | 0.750 | round2 | 0.658 | 0.771 | +0.049 | +0.021 |
| 5-5 | complex | 0.610 | 0.775 | round2 | 0.704 | 0.781 | +0.094 | +0.006 |
| 5-3 | complex | 0.681 | 0.762 | anchor | 0.681 | 0.762 | +0.000 | +0.000 |
| 5-2 | complex | 0.683 | 0.793 | round2 | 0.701 | 0.781 | +0.018 | -0.012 |
...
| 3-8 | continuous | 0.561 | 0.723 | round3 | 0.590 | 0.717 | +0.028 | -0.006 |
...
| 1-3 | staggered | 0.550 | 0.779 | round3 | 0.680 | 0.825 | +0.130 | +0.046 |
| 1-5 | staggered | 0.555 | 0.549 | round3 | 0.684 | 0.892 | +0.129 | +0.343 |
| 1-1 | staggered | 0.607 | 0.787 | round1 | 0.629 | 0.790 | +0.023 | +0.003 |
| 1-4 | staggered | 0.646 | 0.556 | round2 | 0.722 | 0.578 | +0.076 | +0.022 |
| 1-2 | staggered | 0.648 | 0.821 | round2 | 0.714 | 0.819 | +0.066 | -0.002 |
| 2-4 | staggered | 0.676 | 0.835 | round3 | 0.709 | 0.816 | +0.033 | -0.019 |
| 2-2 | staggered | 0.699 | 0.673 | round2 | 0.757 | 0.843 | +0.058 | +0.170 |

## Direction agreement (refined cases)

- Refined cases: 15
- Proxy and GT move same direction: 10/15

## Artefacts

- Selections: `/home/boringtao/Projects/Proxy4Tun/data/sc-general/stage3/selections-fable/`
- CSV: `/home/boringtao/Projects/Proxy4Tun/data/sc-general/stage3/refined_scores_fable.csv`
- Campaign log: `/home/boringtao/Projects/Proxy4Tun/data/sc-general/stage3/campaign_fable.md`
- Gate: `/home/boringtao/Projects/Proxy4Tun/data/sc-general/stage3/gate_fable.md`
