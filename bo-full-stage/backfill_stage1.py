...
from pipeline import run_stages  # noqa: E402
from spaces import CASE_CONFIG, FAMILY_HOLDOUT_SUBSETS, family_of_subset, sibling_anchor_case  # noqa: E402
from intrinsics import (  # noqa: E402
    compute_orient_axis,
    parse_tier0_from_log,
)
from features import ANCHOR_PARAMS, HOLDOUT_SUBSETS, TRAIN_ANCHORS, family_of_subset as fam_of  # noqa: E402

DATA_ROOT = REPO_ROOT / "data" / "bo-full-stage"
OUT_JSON = REPO_ROOT / "bo-full-stage" / "stage1_features.json"
