...
from pipeline import parse_performance  # noqa: E402

OUT = Path(__file__).resolve().parent / "training_table.csv"
STAGE1 = Path(__file__).resolve().parent / "stage1_features.json"
V2_TABLE = BO_ELEGANT / "family" / "training_table_v2.csv"
V2_DATA = REPO_ROOT / "data" / "bo-elegant"
FULL_DATA = REPO_ROOT / "data" / "bo-full-stage"
...
def main() -> None:
    ...
    excl_path = Path(__file__).resolve().parent / "excluded_for_balance.json"
