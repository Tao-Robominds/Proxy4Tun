...
from bo.unified.intrinsics import TIER1_KEYS, extract_intrinsics
...
from bo.elegant.train_proxy_v2 import (
    calibrate_alarm,
    fit_ridge,
    permutation_control,
    predict,
...
REPORT = ELEGANT_PKG / "report.md"
HARNESS_GATE = ELEGANT_PKG / "ablation_harness_gate.md"
...
def build_train_matrix() -> pd.DataFrame:
    ...
    from bo.elegant.features import FAMILY_OF
