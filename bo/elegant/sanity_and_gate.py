...
from bo.paths import REPO_ROOT, ELEGANT_PKG
from bo.elegant.features import ANCHOR_PARAMS, CANDIDATE, TRAIN_ANCHORS, extract_lean, lean_vector, load_metrics_from_run
from bo.elegant.train_proxy import predict

MODELS_PATH = ELEGANT_PKG / "family" / "models.json"
GATE_PATH = ELEGANT_PKG / "validation_gate.md"
SANITY_PATH = ELEGANT_PKG / "family" / "anchor_sanity.json"
...
def validation_gate_3_3() -> dict:
    ...
    registry = json.loads((ELEGANT_PKG / "registry.json").read_text(encoding="utf-8"))
