#!/usr/bin/env python3
"""Resumable GPT-5.6 Stage-3 campaign orchestrator (arm=gpt56).
...
gpt-5.6-sol-medium subagent per case (resumed for rounds 2–3).

Usage:
  ./venv/bin/python bo/sc_general/run_gpt56_campaign.py --derive-panel
  ./venv/bin/python bo/sc_general/run_gpt56_campaign.py --emit 3-4
  ...
  ./venv/bin/python bo/sc_general/run_gpt56_campaign.py --finish 3-4
  ./venv/bin/python bo/sc_general/run_gpt56_campaign.py --status
"""
...
CAMPAIGN = STAGE3 / "campaign_gpt56.md"
...
AGENT_STATE = STAGE3 / "gpt56_agent_state.json"
FREE_PAUSE_GB = 50.0
KEEP_ROUND_NAMES = {
...
def emit_packet(subset: str, *, write_overlay: bool = True) -> dict[str, Any]:
    ...
    prompt = f"""# GPT-5.6 reflection — subset {subset} (propose round {next_round})
