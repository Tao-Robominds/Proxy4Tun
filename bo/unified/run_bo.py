...
from bo.unified.pipeline import (  # noqa: E402
    DATA_ROOT,
    copy_checkpoint,
    parse_performance,
    run_stages,
...
from bo.unified.spaces import CASE_CONFIG, anchor_vector, decode_vector, space_for_case  # noqa: E402
    ...
    def run_full(
        ...
        *,
        ...
        if overlay is not None and not x:
            try:
                from bo.unified.spaces import encode_params
