...
Memory also bundles the SAM4Tun reference parameters for the stage (Table~\ref{tab:denoise-params}), so the agent always has a \emph{reference-sibling baseline} to deviate from.
